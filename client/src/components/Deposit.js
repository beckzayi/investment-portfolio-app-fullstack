	...
	renderBalance() {
		...
		return(
			<div className="py-4">
				...
				<div className="pl-2 pt-2">Your credits in your account.</div>
			</div>
		);
	}
			...
			<form onSubmit={this.handleSubmit} className="py-2">
				<div className="row">
					<div className="col-md-6">
						<p className="font-weight-bold">Deposit credits to your account</p>
			      ...
			      <button type="submit" className="btn bg-dark my-2 float-right text-light w-50 text-uppercase">Deposit</button>
			     </div>
	      </div>
			</form>
		);
...
export default connect(mapStateToProps, { addCredits })(Deposit);
